...
{
	$maNSX=$_GET["ID"];
	$sqlTagPro="select * from sanpham 
	where MaNSX='$maNSX'";
	$rsTagPro = load($sqlTagPro);
	$data = $rsTagPro->fetch_object();
...
require_once 'config.php';
 ...
 $rowperpage=9;
   ...
   $offset=($curpage-1)*$rowperpage;
     ...
     $sqlTagPro = "select * from sanpham s where s.MaNSX = '$maNSX' LIMIT $offset, $rowperpage";
...
$rsTagPro = load($sqlTagPro);
									...
									while($data = $rsTagPro->fetch_object())
									 {
				        			?>
							...
							<div class="product__content content--center">
		        				...
		        				<?php  }
        		        				 ...
        		        				 $sql="select count(*) from sanpham  s where s.MaNSX = '$maNSX' ";
	   ...
	   <ul class="wn__pagination" >
	    ...
	    for($page=1;$page<=$number_of_pages;$page++)
		{
			?>
			 ...
			 <li class="active"> <?php echo "<a href='cacnsx.php?ID=".$maNSX."&page=".$page."'>".$page."</a>"; ?></li>
