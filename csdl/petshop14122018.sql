...
) ENGINE=MyISAM AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `dathang` (`ID`, `UserID`, `TongTien`, `TinhTrang`, `NgayTao`, `NgayDuKienGiao`, `DiaChiGiao`, `TenNguoiNhan`, `SDT`) VALUES
(4, 1, 275000, 'Đang giao', '2018-12-26', NULL, '123ngyt,', 'abc', '123'),
(3, 1, 700000, 'Đang giao', '2018-12-26', NULL, '123ngyt,', 'abc', '123'),
(5, 1, 99000, 'Đang giao', '2018-12-26', NULL, '123ngyt,', 'abc', '123'),
(6, 1, 169000, 'Đang giao', '2018-12-26', NULL, '123ngyt,', 'abc', '123'),
(7, 1, 600000, 'Chưa giao', '2018-12-27', NULL, '123ngyt,', 'abc', '123');
...
INSERT INTO `diachinhan` (`ID`, `UserID`, `TenNguoiNhan`, `SDT`, `DiaChiGiao`) VALUES
(1, 1, 'fsdg7777', '77', 'sdaf7777777777777'),
(2, 1, 'dsà', '23', 'fs7ff'),
(3, 1, 'dsf7', '777', 'czf7v'),
(4, 1, 'fs7777', '7777777777', '777fs77777777'),
(5, 1, 'fsdg7777', '555', 'fsrf');
...
INSERT INTO `nguoidung` (`ID`, `UserName`, `Pass`, `Email`, `HinhAnh`, `Quyen`, `DiaChi`, `SDT`) VALUES
(1, 'abc', '123', 'asdd7212@dsg77777777', 'img/userdefaultphoto.jpg', NULL, '123ngyt,', '123');
...
) ENGINE=MyISAM AUTO_INCREMENT=777777782 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
(41, 'Balo lưới', 4, 'Ba lô thiết kế thười trang nho gọn cho thú cưng mang trên lưng', '2018-12-26', 99, 'images/product/4.7.jpg', 'Nhật Bản', 4, 12000, 0000000000, NULL),
(42, 'Khăn cute', 3, 'Khăn tắm siêu thấm cho chó\r\n- mèo\r\n- Không giống với các loại khăn bông thông thường khác\r\n- khả năng thấm hút nước cực nhanh trong thời gian ngắn sẽ giúp tiết kiệm rất nhiều thời gian trong quá trình lau khô cho vật nuôi chỉ cần vắt là khô mà không cần phơi như khăn bông bình thường khác.Hdsd: Sau khi các pé đã tắm xong ', '2018-12-12', 99, 'images/product/3.7.jpg', 'Nhật Bản', 5, 45000, 0000000000, NULL),
(43, 'Balo phi hành gia cao cấp', 4, 'Là mẫu mới nhất 2018 được thiết kế nhiều lỗ thông khí và lưới cho thú cưng thoải mái.Mặt trước balo bằng nhựa trong suốt giúp thú cưng dễ dàng tương tác với thế giới bên ngoài.Đặc biệt với 5 màu thời trang, trẻ trung.Chó thích nó, mèo thích nó, bạn cũng sẽ thích nó!', '2018-11-18', 99, 'images/product/4.5.jpg', 'Việt Nam', 3, 350000, 0000000000, NULL),
(44, 'Máy cạo lông', 3, 'Máy cắt lông cho chó KM-809A có công suất mạnh mẽ có thể hớt được những vùng lông rậm rạp nhất.\r\nLưỡi dao bằng chất liệu cao cấp, rất dầy dặn, chắc chắn, sắc bén và an toàn khi sử dụng.\r\nLẫy điều chỉnh độ dài ngắn của lông tiện lợi khi cần tỉa lông cho thú cưng.', '2019-03-03', 99, 'images/product/3.8.jpg', 'Hàn Quốc', 3, 120000, 0000000000, NULL),
(45, 'Baolo dài quai', 4, 'Balo Túi vận chuyển chó, mèo\r\nTúi vận chuyển chó mèo giúp bạn mang thú cưng của mình đi xa, về quê, đi khám chữa bệnh, dạo phố dễ dàng, thuận lợi.\r\nTúi chỉ bằng 1 chiếc ba lô đi học, đi du lịch của người nhưng được kết cấu chắc chắn, có lỗ thông khí đảm bảo cho thú cưng có thể thở\r\n\r\n', '2018-08-19', 99, 'images/product/4.6.jpg', 'Việt Nam', 3, 120000, 0000000000, NULL);
COMMIT;
